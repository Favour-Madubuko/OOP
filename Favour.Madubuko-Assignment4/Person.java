...
public class Person {
  ...
  // Write static methods, setDrivingAge and getDrivingAge, to set and get the
  // driving age.
  ...
  // Add a method, canDrive, that returns whether or not a person can drive, given
  // the driving age.

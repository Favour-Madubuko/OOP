/* This program creates the Car Class and tests the basic understanding of instantiation and defining constructor methods */
public class Car {
    private Person Driver = new Person();
    private Person frontSeatPassenger = new Person();
    private Person backSeatPassenger1 = new Person();
    private Person backSeatPassenger2 = new Person();
    private Person backSeatPassenger3 = new Person();

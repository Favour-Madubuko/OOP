...
/*
 * This is a program illustrates what would happen if you try to append to the same file
...
public class WriteToFileDemo3{
    ...
    public static void doAddition(String[] args) {
        ...
        try{
            ...
            FileWriter outFile = new FileWriter("textfiles/Result.txt", true);

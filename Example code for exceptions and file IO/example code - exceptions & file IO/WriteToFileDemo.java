...
/*
 * This is a program that reads three command line arguments
...
public class WriteToFileDemo{
    ...
    public static void doAddition(String[] args) {
        ...
        try{
            ...
            FileWriter outFile = new FileWriter("textfiles/sumResult.txt");
      ...
      public static void doMultiplication(String[] args) {
        ...
        try{
            ...
            FileWriter outFile = new FileWriter("textfiles/productResult.txt");
